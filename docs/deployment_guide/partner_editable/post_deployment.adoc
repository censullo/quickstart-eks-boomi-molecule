...
Add listeners to the Application Load Balancer and Network Load Balancer.
...
https://docs.aws.amazon.com/elasticloadbalancing/latest/application/create-https-listener.html#addanhttpslistener

https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/resource-record-sets-creating.html

https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html#addrulestoasecuritygroup
...
. https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/resource-record-sets-creating.html[Add a new A record] to your domain name in Amazon Route 53.
. https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/resource-record-sets-editing.html[Edit the record name].
. https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-to-elb-load-balancer.html#configuringamazonroute53toroutetraffictoanelbloadbalancer[Route traffic] to the Network Load Balancer.
