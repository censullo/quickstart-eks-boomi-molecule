...
Ensure that your Dell Boomi account has at least one available Enterprise Molecule license and that you have a valid Boomi account ID and login credentials.
